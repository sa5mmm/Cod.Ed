"""
This skill is a more practical skill we can use to add students to a roster.
We are using what is called “DynamoDB”, a database on amazon
"""
import boto3
...
def GetStudent(intent, session):
    ...
    speech_output = "Your student, " + student + " has " + str(info['Item']['GoldStar']) + " gold stars"
    reprompt_text = "The student " + student + " has " + str(info['Item']['GoldStar']) + " gold stars"
...
def RemoveStar(intent, session):
    ...
    speech_output = "Your student, " + student + " has lost " + str(stars) + " gold stars"
    reprompt_text = "The student " + student + " has " + str(stars) + " less gold stars"
